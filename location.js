  ...
  data.forEach((item) => {
    if (item.latitude && item.longitude) {
      const marker = new google.maps.Marker({
        ...
        title: item.name,
        icon:
          "https://uploads-ssl.webflow.com/5ea4822fd3a80f6c9cc4fdd9/5f81e4e7374a417200dc2551_Geo_Tag.svg",
      });
    ...
    styles: [
      {
        ...
        width: 54,
        url:
          "https://firebasestorage.googleapis.com/v0/b/cosm-870d4.appspot.com/o/cluster%2Fm1.svg?alt=media&token=2f77f4ce-3db1-41e8-ad5b-0e90eacfc3a3",
      },
    ],
  });
}
